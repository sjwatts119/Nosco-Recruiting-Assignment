<div>
    <div class="bg-gray-800 p-6 rounded-lg">
        <form wire:submit.prevent="{{ $isEdit ? 'editItem' : 'addItem' }}">
            <div class="mb-4">
            ...
            <div class="flex justify-end">
                <button type="submit" class="bg-blue-500 hover:bg-blue-700 text-white text-sm py-2 px-4 rounded-lg transition">
                    {{ $isEdit ? 'Confirm Changes' : 'Add New Item' }}
                </button>
            </div>
        </form>
    </div>
