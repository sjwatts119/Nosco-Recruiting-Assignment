        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="route('agreements.index')" :active="request()->routeIs('agreements.index') || request()->routeIs('agreements.show') || request()->routeIs('agreements.create')" wire:navigate>
                        {{ __('Agreements') }}
                    </x-nav-link>
                </div>

                {{-- if user is admin, give access to reports --}}
