<tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600 transition">
    ...
    <td class="px-6 py-4">
        £{{ number_format($item['cost_price'], 2) }} (Total: £{{ number_format($item['cost_price'] * $item['quantity'], 2) }})
    </td>
    <td class="px-6 py-4">
        £{{ number_format($item['retail_price'], 2) }} (Total: £{{ number_format($item['retail_price'] * $item['quantity'], 2) }})
    </td>
